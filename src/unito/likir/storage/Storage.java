...
/**
 * A Node Storage is a data structure where DHT contents are kept. When a node
 * receives a valid store request it must save the related StorageEntry in its
 * Storage Provides methods to store and retrieve the StorageEntries
 *
...
public interface Storage extends Serializable
{
    ...
    /**
     * Gets a view of the of the entries corresponding to the couple
     * <key,ownerId>
     * If the parameter recent is set it returns only the first element of the
     * list corresponding to the couple <key,ownerId>
     *
     ...
     * @return the removed list, null if there is no value stored for
     * <key,type,ownerId>
     */
     ...
     *
     * @param key the key the check result
     */
     ...
     *
     * @param key the key
     * @param type the type the check result
     */
    public boolean contains(NodeId key, String type);

    /**
     * Returns whether or not exists a user-bucket corresponding to
     * <key,type,ownerId>
     *
     * @param key the key
     * @param type the type
     * @param ownerId the owner id the check result
     */
