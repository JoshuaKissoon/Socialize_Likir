...
/**
 * Kademlia node 160 bit identifier Adapted from: Mojito Distributed Hash Table
 * (Mojito DHT) Copyright (C) 2006-2007 LimeWire LLC
 *
...
public final class NodeId implements Serializable, Comparable<NodeId>, Cloneable
{
    ...
    /**
     * Constructs a NodeId object from a raw byte array. The specified array
     * length <g>must</g> be equals to NodeId.LENGTH
     *
    ...
    /**
     * Returns the raw bytes of the current NodeId. The returned byte[] array is
     * a copy and modifications are not reflected to this NodeId
     */
    ...
    /**
     * Create a new NodeId setting or unsetting the 'bitIndex'th bit of this
     * NodeId
     *
    ...
    /**
     * Flips the specified bit from 0 to 1 or vice versa and returns a new
     * NodeId instance
     *
    ...
    /**
     * Compares this NodeId with the specified NodeId for order. Returns a
     * negative integer, zero, or a positive integer as this NodeId is less
     * than, equal to, or greater than the specified NodeId.
     *
    ...
    /**
     * Returns the number of bits in this NodeId different from the
     * corresponding bits in the NodeId specified as parameter.
     *
     * @param nodeId the NodeId to be compared with this NodeId
     *
    ...
    /**
     * Returns the first bit that differs in this KUID and the given KUID or
     * KeyAnalyzer.NULL_BIT_KEY if all 160 bits are zero or
     * KeyAnalyzer.EQUAL_BIT_KEY if both KUIDs are equal
     *
