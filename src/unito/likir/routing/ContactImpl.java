...
public class ContactImpl implements Contact, Comparable<ContactImpl>
{
    ...
    /**
     * Constructs a RemoteContact from the specified parameters. Initializes the
     * contact state to ALIVE and the failure counter to zero
     *
     * @param nodeId contact NodeId
     * @param address contact SocketAddress
     */
    ...
    /**
     * Returns the number of failures have occurred since the last successful
     * contact
     *
    ...
    /**
     * Increments the failure counter, sets the last dead or alive time and so
     * on
     */
